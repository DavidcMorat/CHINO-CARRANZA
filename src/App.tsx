...
import { NotificacionesBar } from './components/NotificacionesBar';
    ...
    <div className={`min-h-screen bg-neutral-950 text-neutral-100 flex font-sans antialiased selection:bg-red-600 selection:text-white ${theme === 'light' ? 'light-theme' : ''}`}>
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto max-h-screen pt-16 lg:pt-8 pb-20 lg:pb-8">
        <div className="max-w-7xl mx-auto space-y-5">
          {/* Notificaciones arriba de la App (Barra Superior) */}
          <NotificacionesBar
            alerts={calendarAlerts.alerts}
            totalPagosHoy={calendarAlerts.totalPagosHoy}
            conteoPagos={calendarAlerts.conteoPagos}
            conteoPresupuestos={calendarAlerts.conteoPresupuestos}
            conteoNotas={calendarAlerts.conteoNotas}
            conteoEgresos={calendarAlerts.conteoEgresos}
            conteoTrabajos={calendarAlerts.conteoTrabajos}
